...
void CStereoscopicsManager::OnPlaybackStarted(void)
{
  ...
  // first pause so that user doesn't miss anything while we switch GUI into stereoscopic mode
  ...
  case 0: // Ask
    {
      ...
      // add choices
      pDlgSelect->Add( g_localizeStrings.Get(36530) ); // prefered stereoscopic
  ...
  // after GUI switched, continue playback
