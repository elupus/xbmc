...
#define CONF_FLAGS_STEREO_RENDERMODE_MASK(a) ((a) & 0x020000)
#define CONF_FLAGS_STEREO_RENDERMODE_STEREOSCOPIC   0x010000
#define CONF_FLAGS_STEREO_RENDERMODE_MONO           0x020000
